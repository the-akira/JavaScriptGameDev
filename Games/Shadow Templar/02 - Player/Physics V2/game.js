class Player {
    constructor(game) {
        ...
        this.height = 32; // Altura do jogador
    ...
    draw() {
        this.game.ctx.fillStyle = '#232F45'; // Cor do jogador
        this.game.ctx.fillRect(this.x - this.game.cameraX, this.y - this.game.cameraY, this.width, this.height);
    }
}
        ...
        for (let y = 0; y < this.map.length; y++) {
            for (let x = 0; x < this.map[y].length; x++) {
                ...
                if (tile === 1) {
                    ...
                    this.ctx.fillRect(x * this.tileSize - cameraX, y * this.tileSize - cameraY, this.tileSize, this.tileSize);
                } else if (tile === 0) {
