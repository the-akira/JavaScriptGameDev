...
async function init(){
  try {
    ...
    const [[tileset, door, gun, bullet, ladder, barrel], , , , , , mapsRaw, laserFrames, barrierFrames, buttonShootFrames, [toggleOn, toggleOff], , splashFrames, explosionFrames] = await Promise.all([
